...
_base_ = [
    ...
    '../_base_/datasets/uda_cityscapes_to_acdc_c_snow_512x512_wo_norm.py',
...
uda = dict(
    ...
    ctrst_feat_lambda = 0.02,
    ctrst_out_lambda = 0.02,
    )
data = dict(
    train=dict(
        # Rare Class Sampling
...
name = 'cs2acdc_night_uda_fda_ctrst'
exp = 'basic'
name_dataset = 'cityscapes2acdcallconditions'
